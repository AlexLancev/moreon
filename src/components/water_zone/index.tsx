  ...
  ({ tabs_store }: { tabs_store: Water_zone_tabs_type }) => {
    ...
    return (
      <section className="py-12">
        <Container>
          <div className="relative px-4 py-8 lg:px-8 lg:py-12 2xl:px-12 2xl:py-16 after:absolute after:inset-0 after:-z-10 after:bg-water-zone-gradient-custom">
            <picture>
              <source
            ...
            <Tabs
              ...
              tab_list={tab_list}
            />
            <div className="md:flex md:items-center md:justify-between gap-x-5 pt-2 xl:*:w-1/2">
              <div className="w-full mb-14">
                <Title className="mb-5 text-3xl">
                  {head}
                </Title>
                <p className="mb-8 text-lg xl:text-xl 2xl:text-2xl">{description}</p>
              ...
              <picture>
                ...
                <img
                  className="h-[250px] md:h-[300px] xl:h-[350px] m-auto overflow-hidden rounded-3xl object-cover"
                  width={525}
                  src={images_url?.jpg}
