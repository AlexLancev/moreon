...
export const Footer = () => {
  return (
    <footer className="bg-[rgba(0,0,0,0.3)] pt-10">
      <Container>
        <div className="grid md:grid-cols-4 xxs:grid-cols-1 md:place-items-center xxs:place-items-start gap-x-5 md:gap-x-2 pb-10 border-b-[1px] border-[rgba(255,255,255,0.3)]">
          <div className="xxs:hidden md:block">
            <Logo className="mb-10" />
            <strong className="block mb-3 lg:text-base xl:text-xl 2xl:text-2xl 3xl:text-3xl">
              Обратная связь
            </strong>
            <Feedback className="flex-col items-start justify-end gap-y-4 mb-5" />
          </div>
          <Opening_hours />
          <Menu className="md:flex xxs:hidden flex-col items-start xxs:gap-y-1 lg:gap-y-2 xl:gap-y-3 2xl:gap-y-4" />
          <div className="xxs:hidden md:block">
            <strong className="block mb-3 2xl:mb-6 lg:text-base xl:text-xl 2xl:text-2xl 3xl:text-3xl">
            ...
            <b className="lg:text-base xl:text-xl 2xl:text-2xl 3xl:text-3xl">
              Разработано:{" "}
            </b>
            <a
        ...
        <div className="flex 2xl:flex-row xxs:flex-col justify-between gap-x-3 py-4 text-sm">
          <div className="md:max-w-[590px] xxs:mb-4 lg:text-base 3xl:text-xl">
          ...
          {documents_data && documents_data.length !== 0 && (
            <ul className="flex xxs:*:flex-initial flex-wrap md:justify-start gap-5 xxs:gap-y-2 xxs:gap-x-4">
