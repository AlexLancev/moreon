...
export const RegistrationAccountFormSchema = z.object({
  email: z
    .string()
    .regex(
  ...
  password: z
    ...
    .regex(/([A-Z]|[А-Я])/, "Нужна хотя бы 1 заглавная буква (A-Z или А-Я)")
    .regex(/([a-z]|[а-я])/, "Нужна хотя бы 1 строчная буква (a-z или а-я)")
    .regex(/[0-9]/, "Нужна хотя бы 1 цифра (0-9)")
    .regex(/[!@#$%^&*]/, "Нужен хотя бы 1 спецсимвол (!@#$%^&*)"),
});
